			...
			<div class="widget-content widget-content-area">
				...
				<div class="row">
					<div class="col-12">
						...
						<form action="{{ route('strains.store') }}" method="POST" class="form" id="formStrain">
							@csrf
							<div class="row">
								...
								<div class="form-group col-12">
									<div class="btn-group" role="group">
										<button type="submit" class="btn btn-primary mr-0" action="strain">Guardar</button>
