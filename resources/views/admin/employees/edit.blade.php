						...
						<form action="{{ route('employees.update', ['employee' => $employee->slug]) }}" method="POST" class="form" id="formEmployee" enctype="multipart/form-data">
							...
							<div class="row">
								<div class="form-group col-lg-6 col-md-6 col-12">
									...
									<input type="file" name="photo" accept="image/*" class="dropify" data-height="125" data-max-file-size="20M" data-allowed-file-extensions="jpg png jpeg web3" data-default-file="{{ image_exist('/admins/img/users/', $employee->photo, true) }}" />
								</div>
								...
								<div class="form-group col-lg-6 col-md-6 col-12">
									<div class="row">
										<div class="form-group col-lg-12 col-md-12 col-12">
											...
											<input class="form-control @error('name') is-invalid @enderror" type="text" name="name" required placeholder="Introduzca un nombre" value="{{ $employee->name }}">
										</div>

										<div class="form-group col-lg-12 col-md-12 col-12">
											<label class="col-form-label">Apellido<b class="text-danger">*</b></label>
											<input class="form-control @error('lastname') is-invalid @enderror" type="text" name="lastname" required placeholder="Introduzca un apellido" value="{{ $employee->lastname }}">
										</div>
									</div>
								</div>
								...
								<div class="form-group col-lg-6 col-md-6 col-12">
									...
									<select class="form-control @error('state') is-invalid @enderror" name="state" required>
										<option value="1" @if($employee->state=="1") selected @endif>Activo</option>
										<option value="0" @if($employee->state=="0") selected @endif>Inactivo</option>
									</select>
								</div>

								<div class="form-group col-12">
									<div class="btn-group" role="group">
										<button type="submit" class="btn btn-primary" action="employee">Actualizar</button>
