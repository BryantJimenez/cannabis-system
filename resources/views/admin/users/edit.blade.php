						...
						<form action="{{ route('users.update', ['user' => $user->slug]) }}" method="POST" class="form" id="formUser" enctype="multipart/form-data">
							...
							<div class="row">
								<div class="form-group col-lg-6 col-md-6 col-12">
									...
									<input type="file" name="photo" accept="image/*" class="dropify custom-error" data-height="125" data-max-file-size="20M" data-allowed-file-extensions="jpg png jpeg web3" data-default-file="{{ $user->photo_url }}" />
								...
								<div class="form-group col-lg-6 col-md-6 col-12">
									...
									<input class="form-control number @error('phone') is-invalid @enderror" type="text" name="phone" required placeholder="Introduzca un teléfono" value="{{ old('phone', $user->phone) }}">
								</div>
								...
								<div class="form-group col-12">
									<div class="btn-group" role="group">
										...
										<a href="{{ route('users.index') }}" class="btn btn-secondary mr-0">Volver</a>
									</div>
								</div> 
							</div>
						</form>
