						...
						<form action="{{ route('users.store') }}" method="POST" class="form" id="formUser" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="form-group col-lg-6 col-md-6 col-12">
									...
									<input class="form-control number @error('phone') is-invalid @enderror" type="text" name="phone" required placeholder="Introduzca un teléfono" value="{{ old('phone') }}">
								</div>
								...
								<div class="form-group col-12">
									<div class="btn-group" role="group">
										<button type="submit" class="btn btn-primary mr-0" action="user">Guardar</button>
